...
from pytorch_tabnet.multiclass_utils.validation import assert_all_finite, check_output_dim, check_unique_type
...
def test_check_output_dim_empty_array():
    ...
    import pytorch_tabnet.multiclass_utils.validation as validation
